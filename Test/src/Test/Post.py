...
class test_post(unittest.TestCase):  # 測試項目
    ...
    def test_create_post(self):
        ...
        exist = is_text_present( test, 'I AM GP' )
    ...
    def test_search_post(self):
        ...
        ExpectText = search_post( test,'I' )
        self.assertEqual( ExpectText, 'I AM GP' )
        ExpectText = search_post( test,'I AM')
        self.assertEqual( ExpectText, 'I AM GP' )
        ExpectText = search_post( test,'I AM GP' )
        self.assertEqual( ExpectText, 'I AM GP' )
